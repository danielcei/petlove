<div x-data="{ open: false }" class="mt-3">
    ...
    <h2>
        <button @click="open = !open"
                class="text-lg text-left w-full flex justify-between items-center p-3 rounded shadow {{$bgColor}}"><b>Consultas Realizadas</b>
        ...
        <div>
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <th class="border  border-gray-300 p-2 text-center">Quantidade Dias Consultados</th>
                </tr>
                </thead>
